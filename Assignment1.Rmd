...
$$
SSE = \displaystyle\sum_{i=1}^{n}\varepsilon^2 = \displaystyle\sum_{i=1}^{n}(y-\^y)^2
$$
...
$
SSE=\displaystyle\sum_{i=1}^{n}\varepsilon^2 = \displaystyle\sum_{i=1}^{n}(y-\^y)^2 = \displaystyle\sum_{i=1}^{n}(y_i-\^\beta_0-\^\beta_1x_{1i}-\^\beta_2x_{2i}-\dotsc-\^\beta_kx_{ki})^2
$
...
the better model.
$$
RMSE=\sqrt{MSE}=\sqrt{\frac{\sum_{i=1}^n(y-\^y)^2}{n}}
$$
